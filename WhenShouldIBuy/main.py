...
def main():
    ...
    y_pred_all = rp.real_prediction(528, lin_reg_2, poly_reg, 'samsung-galaxy-note-4-duos-sm-n9100')
    ...
    y_pred_all = rp.real_prediction(479, lin_reg_2, poly_reg, 'Sony Xperia XZ1 Compact G8441')
